                ...
                <div class="uk-navbar-right impx-navbar-right">
                    <ul class="uk-navbar-nav impx-nav style2">
                        ...
                        <li class="uk-parent uk-active">
                            <a href="{{ route('home') }}" class="uk-navbar-nav-subtitle"><div>Home<div class="uk-navbar-subtitle">Welcome</div></div></a>

                        </li>
                        <li>
                            <a href="{{ route('destination') }}" class="uk-navbar-nav-subtitle"><div>Destination<div class="uk-navbar-subtitle">Our Best Suites</div></div></a>
                        ...
                        <li><a href="{{ route('trips') }}"><div>Trips<div class="uk-navbar-subtitle">In-house Restaurant</div></div></a></li>
                        <li><a href="spa.html"><div>blog<div class="uk-navbar-subtitle">Our Spa Service</div></div></a></li>
                        ...
                        <li class="uk-parent">
                            <a href="#" class="uk-navbar-nav-subtitle"><div>About Us<div class="uk-navbar-subtitle">the Other Pages</div></div></a>
                        </li>
